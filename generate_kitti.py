...
if __name__ == '__main__':
    ...
    # create dataloader
    test_dataset = dataset.KITTI360Dataset('data/KITTI-360/data_3d_pointcloud', split,
        ...
        for ind, data in enumerate(test_loader):
            ...
            if save_input:
                ...
                o3d.io.write_point_cloud(
                    'output' + save_fold + '/kittiinput_{}_{}_{}_{}.ply'.format(split, category, checkpoint, ind), pcd)
    ...
    if latentsp_interp:
        x1 = test_dataset.__getitem__(conditioned_ind1)['points_tgt'].unsqueeze(0)
        x2 = test_dataset.__getitem__(conditioned_ind2)['points_tgt'].unsqueeze(0)
        ...
        for i in range(len(lambda_range)):
            ...
            o3d.io.write_triangle_mesh(
                'output' + save_fold + '/kittimesh_{}_{}_interp_{}_{}_{}.ply'.format(split, checkpoint,
                                                                                     conditioned_ind1,
