...
class MeshEvaluator(object):
    ...
    def eval_mesh(self, mesh, pointcloud_tgt, normals_tgt=None):
        ...
        if len(mesh.vertices) != 0 and len(mesh.faces) != 0:
            pointcloud = mesh.sample(self.n_points)
    ...
    def eval_pointcloud(self, pointcloud, pointcloud_tgt,
        ...
        completeness_h = completeness.max()
        ...
        hausdorffL1 = max(completeness_h, accuracy_h)

        out_dict = {
            'completeness': completeness,
            'accuracy': accuracy,
            'completeness_h': completeness_h,
